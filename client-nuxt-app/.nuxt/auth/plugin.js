...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/login_check","method":"post","propertyName":"token"},"logout":{"url":"/logout","method":"post"},"user":{"url":"/users/7","method":"get","propertyName":"user"}},"tokenType":"bearer","_name":"local"}))
